document.addEventListener('DOMContentLoaded',()=>{
    ...
    async function fetchData(){
        const res =  await fetch('https://689a169cfed141b96ba1d198.mockapi.io/DIA16Api/Tareas',{
            method: 'GET',
            headers :{
    ...
    async function addNewTask(){
        ...
        console.log(task);
        if (task.trim()==='') return;
        await fetch('https://689a169cfed141b96ba1d198.mockapi.io/DIA16Api/Tareas',{
            method: 'POST',
            headers :{
                'Content-Type':'application/json'
            },
        ...
        capsula.forEach(cap =>{
            ...
            <div class="botones">
                <div class="terminadoNegativo">
                    <img src="./media/bien.png" data-id="${cap["id"]}" alt="">
                </div>
                <div class="eliminadoNegativo">
                    <img src="./media/eliminar.png" data-id="${cap["id"]}" alt="">
                </div>
            </div>
                `
